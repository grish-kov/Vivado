...
#
# Generated by Vivado on Mon Apr 08 14:14:42 +07 2024
...
proc checkRequiredFiles { origin_dir} {
 ...
 "[file normalize "$origin_dir/my_test.srcs/sources_1/new/test.sv"]"\
 ...
 "[file normalize "$origin_dir/my_test.srcs/sim_1/new/tb_led_blink.sv"]"\
 "[file normalize "$origin_dir/my_test.srcs/sim_1/new/tb_test.sv"]"\
 "[file normalize "$origin_dir/tb_test_behav.wcfg"]"\
  ]
  foreach ifile $files {
...
set_property -name "top" -value "tb_led_blink" -objects $obj
set_property -name "top_auto_set" -value "0" -objects $obj
