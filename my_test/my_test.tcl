...
#
# my_test.tcl: Tcl script for re-creating project 'my_test'
#
# Generated by Vivado on Tue May 07 13:36:58 +07 2024
...
#
# 1. This project restoration tcl script (my_test.tcl) that was generated.
#
...
set_property -name "webtalk.xsim_launch_sim" -value "1779" -objects $obj
...
if {[string equal [get_runs -quiet synth_1] ""]} {
    create_run -name synth_1 -part xc7z020clg484-1 -flow {Vivado Synthesis 2021} -strategy "Vivado Synthesis Defaults" -report_strategy {No Reports} -constrset tcl
} else {
...
set obj [get_runs synth_1]
set_property -name "constrset" -value "tcl" -objects $obj
...
if {[string equal [get_runs -quiet impl_1] ""]} {
    create_run -name impl_1 -part xc7z020clg484-1 -flow {Vivado Implementation 2021} -strategy "Vivado Implementation Defaults" -report_strategy {No Reports} -constrset tcl -parent_run synth_1
} else {
