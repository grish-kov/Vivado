...
#
# Generated by Vivado on Fri Apr 12 13:05:25 +07 2024
...
#
#    "/home/grigory/WORK_FOLDER/Vivado/my_test/my_test.srcs/sim_1/imports/my_test/tb_test_behav.wcfg"
#
#*****************************************************************************************
...
proc checkRequiredFiles { origin_dir} {
 ...
 "[file normalize "$origin_dir/my_test.srcs/sim_1/new/tb_lab2a.sv"]"\
  ...
  set files [list \
 "[file normalize "$origin_dir/my_test.srcs/sim_1/imports/my_test/tb_test_behav.wcfg"]"\
  ]
  foreach ifile $files {
    if { ![file isfile $ifile] } {
...
set_property -name "webtalk.xsim_launch_sim" -value "177" -objects $obj
...
set_property -name "top" -value "lab2c_top" -objects $obj
...
set_property -name "target_constrs_file" -value "[get_files *new/chipscope.xdc]" -objects $obj
set_property -name "target_ucf" -value "[get_files *new/chipscope.xdc]" -objects $obj
...
set file "$origin_dir/my_test.srcs/sim_1/imports/my_test/tb_test_behav.wcfg"
...
set_property -name "top" -value "tb_lab2c" -objects $obj
set_property -name "top_auto_set" -value "0" -objects $obj
