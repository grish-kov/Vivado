...
set_property -dict {PACKAGE_PIN V7 IOSTANDARD LVCMOS25} [get_ports {o_led1[4]}]
set_property -dict {PACKAGE_PIN W10 IOSTANDARD LVCMOS25} [get_ports {o_led1[5]}]
set_property -dict {PACKAGE_PIN P18 IOSTANDARD LVCMOS25} [get_ports {o_led1[6]}]
set_property -dict {PACKAGE_PIN P17 IOSTANDARD LVCMOS25} [get_ports {o_led1[7]}]
