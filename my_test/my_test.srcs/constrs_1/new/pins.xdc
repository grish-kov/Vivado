...
#set_property -dict {PACKAGE_PIN D15 IOSTANDARD LVCMOS25} [get_ports o_led[0]]
#set_property -dict {PACKAGE_PIN W17 IOSTANDARD LVCMOS25} [get_ports o_led[1]]
#set_property -dict {PACKAGE_PIN W5 IOSTANDARD LVCMOS25} [get_ports o_led[2]]
#set_property -dict {PACKAGE_PIN V7 IOSTANDARD LVCMOS25} [get_ports o_led[3]]
